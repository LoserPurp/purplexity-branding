...
## Authentik theme · `assets/css/v10/authentik.css`
...
```
https://branding.purplexity.no/assets/css/v10/authentik.css
```
...
| 10 | `assets/css/v10/authentik.css` | Styles the delete dialogs and the profile picture upload field **(current)** |
