...
## Authentik theme · `assets/css/v7/authentik.css`
...
```
https://branding.purplexity.no/assets/css/v7/authentik.css
```
...
| 7 | `assets/css/v7/authentik.css` | Styles the "Change your password" card **(current)** |
