...
## Authentik theme · `assets/css/v8/authentik.css`
...
```
https://branding.purplexity.no/assets/css/v8/authentik.css
```
...
| 8 | `assets/css/v8/authentik.css` | Styles the Update details form and the dashboard's ⋮ button **(current)** |
