...
## Authentik theme · `assets/css/v6/authentik.css`
...
```
https://branding.purplexity.no/assets/css/v6/authentik.css
```
...
| 6 | `assets/css/v6/authentik.css` | Fixes the user details card and styles dialogs and dropdowns **(current)** |
